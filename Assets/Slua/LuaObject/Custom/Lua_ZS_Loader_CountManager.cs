...
public class Lua_ZS_Loader_CountManager : LuaObject {
	...
	static public int Subtract_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(string))){
				...
				var ret=ZS.Loader.CountManager.Subtract(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public int Add_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(string))){
				System.String a1;
				checkType(l,1,out a1);
				var ret=ZS.Loader.CountManager.Add(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"ZS.Loader.CountManager");
		addMember(l,Subtract_s);
		addMember(l,Add_s);
		createTypeMetatable(l,null, typeof(ZS.Loader.CountManager));
	}
}
