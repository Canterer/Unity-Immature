...
public class Lua_ZS_Loader_CacheManager : LuaObject {
	...
	static public int ClearDelay_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(int))){
				...
				ZS.Loader.CacheManager.ClearDelay(a1);
				pushValue(l,true);
				return 1;
			}
	...
	static public int UnloadCacheFalse_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(int))){
				System.Int32 a1;
				checkType(l,1,out a1);
				var ret=ZS.Loader.CacheManager.UnloadCacheFalse(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public int UnloadDependenciesCacheFalse_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(int))){
				System.Int32 a1;
				checkType(l,1,out a1);
				var ret=ZS.Loader.CacheManager.UnloadDependenciesCacheFalse(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public int Unload_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(int))){
				System.Int32 a1;
				checkType(l,1,out a1);
				var ret=ZS.Loader.CacheManager.Unload(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public int Contains_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(string))){
				System.String a1;
				checkType(l,1,out a1);
				var ret=ZS.Loader.CacheManager.Contains(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public int ClearAll_s(IntPtr l) {
		try {
			ZS.Loader.CacheManager.ClearAll();
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int get_Typeof_String(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,ZS.Loader.CacheManager.Typeof_String);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_Bytes(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,ZS.Loader.CacheManager.Typeof_Bytes);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_AssetBundle(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,ZS.Loader.CacheManager.Typeof_AssetBundle);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_ABScene(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,ZS.Loader.CacheManager.Typeof_ABScene);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_ABAllAssets(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,ZS.Loader.CacheManager.Typeof_ABAllAssets);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_AudioClip(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,ZS.Loader.CacheManager.Typeof_AudioClip);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_Texture2D(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,ZS.Loader.CacheManager.Typeof_Texture2D);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_Object(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,ZS.Loader.CacheManager.Typeof_Object);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"ZS.Loader.CacheManager");
		...
		createTypeMetatable(l,null, typeof(ZS.Loader.CacheManager));
	}
}
